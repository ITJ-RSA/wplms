            ...
            if(is_user_logged_in()){
                if(isset($quiztaken) && $quiztaken){
                    if($quiztaken > time()){
                        ...
                        if(isset($quiz_course) && is_numeric($quiz_course) && $quiz_course){
                            echo '<a href="'.bp_loggedin_user_domain().'course/course-results/?action='.get_the_ID().'" class="button full"> '.__('Check Quiz Results','vibe').'</a>';
