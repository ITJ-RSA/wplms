...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'type' => 'button_set',
                        'title' => __('Enable Join Group/Request Membership buttom', 'vibe'),
...
$sections[] = array(
				...
				'fields' => array(
                        ...
                        'type' => 'button_set',
						'options' => array('0' => 'Free Access','1'=>'Force prev Unit/Quiz Complete'),
						'std' => '0'
						),
						array(
						'id' => 'unit_media_lock',
                        ...
                        'type' => 'button_set',
						'options' => array('0' => 'Do not lock','1'=>'Lock Unit Completion'),
						'std' => '0'
						),
						array(
						'id' => 'private_course',
                        ...
                        'options' => array(
                        	'single' => __('Single Answer Multiple Choice','vibe'),
                        	'multiple' => __('Multiple Answer Multiple Choice','vibe'),
...
$sections[] = array(
				...
				'fields' => array( 
                        ...
                        'type' => 'button_set',
						'options' => array('' => 'Show Footer Menu','1'=>'Show Social Icons'),
						'std' => ''
						),             
                        array(
							'id' => 'google_analytics',
...
$sections[] = array(
				...
				'fields' => array(
						...
						'options' => array('' => 'Wide','boxed' => 'Boxed'),
						'std' => ''
						), 
						array(
						'id' => 'excerpt_length',
						...
						'options' => array(0 => 'Disable',1 => 'All Paid Orders',2 => 'All Non-Fail Orders'),
						'std' => 0
						), 
						array(
